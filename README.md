...
- **Parallel Agent Dispatch:** Independent tasks (e.g., DNS config, firewall rules, proxy ACLs) are handled by specialised agents running concurrently, reducing turnaround time.
